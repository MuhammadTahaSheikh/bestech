...
tryN8nFormSubmit(
    getN8nContactWebhookUrl(),
    $n8nPayload,
    __DIR__ . '/contact_log.txt',
    date('Y-m-d H:i:s') . " - Contact (n8n): $name ($email)\n",
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <div class='field'><div class='label'>Service:</div><div class='value'>" . ($service ?: 'Not selected') . "</div></div>
        ...
        <div class='footer'>
            <p>This email was sent from the Bestech Vision contact form.</p>
        </div>
    </div>
</body>
</html>
